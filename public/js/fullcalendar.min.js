  ...
  var qr = (function (e) {
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return (
          this.debug && console.log(ze(e, this.props), ze(t, this.state)),
    ...
    function e(e) {
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : zn(s.now, l)),
    ...
    return (
      ...
      (t.prototype.renderSection = function (e, t, n) {
        return "outerContent" in e
          ...
          : Ar(
              "tr",
              { key: e.key, className: Ji(e, this.props.liquid).join(" ") },
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    Ar(
                      ...
                      Ar(bi, r({ isHeightAuto: i, forPrint: a }, e))
                    )
                  );
                }
              ),
    ...
    Ea = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (ma += 1) &&
            window.addEventListener("touchmove", Sa, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (ma -= 1) ||
              window.removeEventListener("touchmove", Sa, { passive: !1 });
        }),
        (e.prototype.tryStart = function (e) {
          var t = this.querySubjectEl(e),
            n = e.target;
          return (
            !(!t || (this.handleSelector && !F(n, this.handleSelector))) &&
            ((this.subjectEl = t),
            (this.isDragging = !0),
            (this.wasTouchScroll = !1),
            !0)
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(Ra()));
          }
        }),
        ...
        return (
          ...
          (t.renderHeadAxis = function (e) {
            ...
            var n = t.context.options,
              ...
              a =
                n.navLinks && 1 === i
                  ? { "data-navlink": yr(o.start, "week"), tabIndex: 0 }
                  : {};
                  ...
                  content: function (e) {
                    return Ar(
                      ...
                      Ar(
                        ...
                        e.tableColGroupNode,
                        Ar("tbody", null, Ar(bs, { slatMetas: i }))
                      ),
                      Ar(
                        "div",
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            Ar(
              ra,
              r({}, this.props, { defaultTimeFormat: Us, extraClassNames: e })
            )
          );
        }),
        t
                ...
                r(
                  {
                    ...
                    isCondensed:
                      e.bottom - e.top < hi.timeGridEventCondensedHeight,
                  },
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          ...
          var a = e.map(function (e) {
            return Ar(
              ...
              "bg-event" === t
                ? Ar(da, r({ seg: e }, bn(e, i.todayRange, i.nowDate)))
                : ca(t)
            );
          });
          return Ar(Wr, null, a);
